...
Добавим в него атрибуты самого буфера, его длины, которую будем запрашивать при создании объекта, указателями на точку записи и точку чтения
'''
...
Функция merge_sort будет делить массив пополам индексами массива, и вызывать саму себя от своих половин в
аргументах функции merge, пока длина половины не станет равной 1, тогда начнётся сборка отсортированного
массива функцией merge

Функция merge будет на каждом вызове из merge_sort собирать новый отсортированный список из переданных
ей участков массива и возвращать его.
'''
