...
Я, честно, её не нашёл. Возможно, я не увидел какие-то варианты массивов.
Но я проверял функцию на массивах разумной длины.
...
И добавил проверку на пустой массив (в выдаче массива длиной 1 в конце дробления, т.к. меньше длины 1 при
дроблении вернуться не может)
'''
